...
var sncf = {
    ...
    createObstacle:function(){
        ...
        // Every 4 obstacles, change background + increase game speed + create blue background
        if (obstaclesCount % 5 === 0 && obstaclesCount !== 0) {
            // currentSpeed += 200;
            ...
            blueRectangleBg.drawRect(0, 0, 5000, 1900);
    ...
    gameOver: function() {
        ...
        setTimeout(function() {
            ...
            restartLabel.events.onInputOver.add(__this.restartGame(), this, 0);
